...
<body>
    ...
    <div class="text-center mb-4">
        <h2 class="section-title px-5"><span class="px-2">Tabla Newsletter</span></h2>
    </div>
    ...
    <div class="container">
        <table class="table table-hover" id="dev-table">
            ...
            <tbody>
                <?php
                $consult = "SELECT * FROM newsletter";
                ...
                <tr>
                    ...
                    <td><?php echo $fila['correo']; ?></td>
                     <td>
                        <a href="delete_row3.php?name=<?php echo $fila['nombre']; ?>" class="btn btn-sm btn-primary delete-btn">
