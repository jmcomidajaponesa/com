...
<body>
    ...
    <div class="text-center mb-4">
        <h2 class="section-title px-5"><span class="px-2">Tabla Registros</span></h2>
    </div>
        ...
        <table class="table table-hover" id="dev-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="delete_row4.php?name=<?php echo $fila['usuario']; ?>" class="btn btn-sm btn-primary delete-btn">
