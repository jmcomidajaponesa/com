...
<body>
    ...
    <div class="text-center mb-4">
        <h2 class="section-title px-5"><span class="px-2">Tabla Contacto</span></h2>
    </div>
        ...
        <table class="table table-hover" id="dev-table">
            ...
            <tbody>
                ...
                <tr >
                    ...
                    <td><b><?php echo $fila['mensaje']; ?></b></td>
                    
                    <td>
                        <a href="delete_row2.php?name=<?php echo $fila['nombre']; ?>" class="btn btn-sm btn-primary delete-btn">
