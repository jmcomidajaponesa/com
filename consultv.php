...
<body>
    ...
    <div class="container-fluid">
        <div class="row border-top px-xl-5">
                ...
                <a  style="height: 80px; margin-top: -1px; padding: 0 30px;" href="login.html">
                    <button type="submit" class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3">Salir</button>
                </a>
                <a  style="height: 80px; margin-top: -1px; padding: 0 30px;" href="ventas.php">
                    <button type="submit" class="btn btn-lg btn-block btn-primary font-weight-bold my-3 py-3">Atrás</button>
                </a>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 160px">
            ...
            <div class="d-inline-flex">
                <p class="m-0"><a href="consulta.php">Contacto</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0"><a href="consucheck.php">Datos Compra</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0"><a href="consunoti.php">Newsletter</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0"><a href="consureg.php">Registro</a></p>
                <p class="m-0 px-2">-</p>
    ...
    <div class="text-center mb-4">
        <h2 class="section-title px-5"><span class="px-2">VENTAS</span></h2>
    </div>
        ...
        <table class="table table-hover" id="dev-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><b><?php echo $fila['celular']; ?></b></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
